...
import net.mcreator.lotmod.procedures.LatanieOnKeyPressedguiProcedure;
...
public class LatanieKeyBinding extends LotmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.latanie", GLFW.GLFW_KEY_P, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				LatanieOnKeyPressedguiProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
