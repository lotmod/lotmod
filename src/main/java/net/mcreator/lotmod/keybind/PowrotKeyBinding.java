...
import net.mcreator.lotmod.procedures.PowrotOnKeyPressedProcedure;
...
public class PowrotKeyBinding extends LotmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.powrot", GLFW.GLFW_KEY_HOME, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				PowrotOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
